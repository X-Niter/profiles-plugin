...
public class DefaultStatefulItemStackSupplier<S> implements StatefulItemStackSupplier<S> {
	@Override
	public StatefulItemStack<S> get(Integer slot, String legendName, TextSupplier getText) {
		return DefaultStatefulItemStackSupplier.getStatic(slot, legendName, getText);
	}
