...
public class ConsoleOutput {
    ...
    public void colored(String msg) {
        ...
        console.sendMessage(Objects.requireNonNull(ConsoleStringUtils.color(msg)));
    }
    ...
    public void debug(String msg) {
        if (debug) {
            ...
            else Bukkit.getLogger().info(ConsoleStringUtils.stripColor(finalMsg));
    ...
    public void err(String msg) {
        ...
        if (colors) colored(finalMsg);
        else Bukkit.getLogger().severe(ConsoleStringUtils.stripColor(finalMsg));
    ...
    public void warn(String msg) {
        ...
        if (colors) colored(finalMsg);
        else Bukkit.getLogger().warning(ConsoleStringUtils.stripColor(finalMsg));
    ...
    public void toListeners(String message) {
        final String finalMessage = ConsoleStringUtils.color(message);
        listeners.forEach(c -> {
